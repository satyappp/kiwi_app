    ...
    <div className="space-y-6">
      <header>
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <Link href={`/ripening/${id}/label`} target="_blank" className="inline-flex h-10 items-center gap-2 rounded-xl bg-[#557f3e] px-4 text-sm font-bold text-white hover:bg-[#466d33]">
      ...
      <section className="rounded-2xl bg-white/75 p-4 shadow-sm sm:p-6">
        <div className="mb-4">
          ...
          <p className="mt-1 text-xs text-muted-foreground">A5横・実寸レイアウト</p>
        </div>
